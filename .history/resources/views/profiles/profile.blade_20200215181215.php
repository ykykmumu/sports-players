                    ...
                    <div class="card-body row pt-30">
                        ...
                        <div class="col-md-8 mt-5">
                          <dl class="row justify-content-around text-center">
                            <dt class="p-0 col-6">名前：</dt>
                            <dd class="col-6"><h5 class="card-text h4">{{ $user->name }}</h5></dd>
                          </dl>
                          <dl class="row justify-content-around text-center">
                            <dt class="p-0 col-6">自己紹介：</dt>
                            <dd class="col-6"><p class="card-text u">{{ $user->introduce }}</p></dd>
                          </dl>
                          @if(Auth::id() == $user->id)
                          <dl class="row justify-content-around text-center">
                            <dt class="p-0 col-6">メールアドレス：</dt>
                            <dd class="col-6"><p class="card-text u">{{ $user->email }}</p></dd>
                          </dl>
                          @endif
                        </div>     
                    </div>
