            ...
            <div class="card">
                    <div class="card-body row pt-30">
                        ...
                        <div class="col-md-4 offset-md-1">
                          <img src="http://placehold.jp/100x100.png" class="card-img rounded-circle" alt="">
                          <p class="card-text text-center">{{ $user->name }}</p>
                        </div>
                        <div class="col-md-7 mt-5">
                          <dl class="row justify-content-around text-left">
                            <dt class="p-0 col-3">名前：</dt>
                            <dd class="col-7"><h5 class="card-title">{{ $user->name }}</h5></dd>
                          </dl>
                          <dl class="row justify-content-around text-left">
                            <dt class="p-0 col-3">メールアドレス：</dt>
                            <dd class="col-7"><p class="card-text">{{ $user->email }}</p></dd>
                          </dl>
                        </div>     
                    </div>
